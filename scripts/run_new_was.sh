...
#nohup java -jar -Dserver.port=${TARGET_PORT} /home/ubuntu/Chorok/build/libs/* > /home/ubuntu/nohup.out 2>&1 &
nohup java -jar -Dserver.port=${TARGET_PORT} /home/ubuntu/playground_logging/build/libs/* > /home/ubuntu/nohup.out 2>&1 &
